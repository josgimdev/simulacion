...
final int N_Z = 30;         // Number of nodes of the object in the Z direction
...
final float m = 0.1;        // Masa de cada nodo de la estructura deformable (kg).

final float H = 200;       // Altura de la bandera
final float S = 300;       // Separación entre las banderas

final float AirForce = 4;  // Air force from the inside of the deformable object
