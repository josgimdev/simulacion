...
final float R = 0.3;       // Radio de las partículas (m)
...
final float TUBERIA_X = DISPLAY_SIZE_X *.1;  // Tamaño de la tuberia (m)
final float TUBERIA_Y = DISPLAY_SIZE_Y *.1;  // Tamaño de la tuberia (m)
